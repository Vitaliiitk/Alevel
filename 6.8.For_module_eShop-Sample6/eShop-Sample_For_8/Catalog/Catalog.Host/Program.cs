...
builder.Services.AddControllers(options =>
    {
        ...
        options.Filters.Add<LogUnauthorizedAccessFilter>(); // filter to log unauthorized methods
    })
...
builder.Services.AddScoped<LogUnauthorizedAccessFilter>(); // The filter to log message if I try to access method being unauthorized
