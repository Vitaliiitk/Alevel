        ...
        public static IEnumerable<Client> GetClients(IConfiguration configuration)
        {
            return new[]
            {
                new Client
                {
                   ...
                   /* RedirectUris = { $"http://www.alevelwebsite.com:5001/signin-oidc" }, //This way to put uri is for Dbug MVC in Visual Studio: all other containers are deployed in Docker*/ 

                    AllowedScopes = {"openid", "profile", "mvc", "order.orderitem", "basket.basketitem"},
                    RequirePkce = true,
